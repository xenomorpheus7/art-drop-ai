        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-7 text-center transition-all duration-300 hover:glow-soft"
            >
              <div className="w-14 h-14 rounded-xl glass-subtle flex items-center justify-center text-primary mx-auto mb-5">
                {feature.icon}
              </div>
